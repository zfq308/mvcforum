...
namespace MVCForum.Domain.DomainModel.General
{
    ...
    public class TProvince
    {
        ...
        public static List<TProvince> LoadAllProvinceList()
        {
            ...
            ProvinceList.Add(new TProvince() { ProvinceId = 150000, ProvinceName = "内蒙古自治区" });
            ...
            ProvinceList.Add(new TProvince() { ProvinceId = 230000, ProvinceName = "黑龙江省	" });
            ...
            ProvinceList.Add(new TProvince() { ProvinceId = 450000, ProvinceName = "广西壮族自治区" });
            ...
            ProvinceList.Add(new TProvince() { ProvinceId = 540000, ProvinceName = "西藏自治区" });
            ...
            ProvinceList.Add(new TProvince() { ProvinceId = 640000, ProvinceName = "宁夏回族自治区" });
            ProvinceList.Add(new TProvince() { ProvinceId = 650000, ProvinceName = "新疆维吾尔自治区" });
