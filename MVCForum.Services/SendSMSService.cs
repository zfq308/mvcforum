...
namespace MVCForum.Services
{
    ...
    public class UCPaasConfig
    {
        ...
        /// <param name="appId">对应的应用id</param>
    ...
    public partial class SendSMSService_UCPaas : ISendSMSService
    {
        ...
        /// 上线用建构式
        /// </summary>
        /// <param name="ucPaasConfig">云之讯接入配置实例</param>
        ...
        /// <summary>
        /// 通过云之讯平台（www.ucpaas.com）发送SMS短信
        /// </summary>
        /// <param name="Content">短信内容</param>
        /// <param name="MobileNumber">手机号码，群发逗号区分</param>
        /// <returns>
        ...
        public string Send(string Content, string MobileNumber)
        {
            ...
            string param = string.Format("{0}", Content);        //短信参数
